...
//        Все методы должны принимать телевизор как параметр. Последний метод также
//        должен принимать номер канала.
//        Учтите, что каналы не должны быть отрицательными.
//        Переключение канала должно происходить только в том случае, если частота
//        пульта и телевизора совпадают.
...
//        Если попытаться переключить на один канал назад с канала 1, происходит
//        переключение на максимальный канал.
